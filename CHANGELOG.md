...
## [0.3.0](https://github.com/kangjuhyup/auth/compare/auth-v0.2.0...auth-v0.3.0) (2026-09-19)


### Miscellaneous Chores

* **auth:** Synchronize auth versions

## [0.2.0](https://github.com/kangjuhyup/auth/compare/auth-v0.1.1...auth-v0.2.0) (2026-06-06)
...
## [0.1.1](https://github.com/kangjuhyup/auth/compare/auth-v0.1.0...auth-v0.1.1) (2026-04-05)
...
## [0.1.0](https://github.com/kangjuhyup/auth/compare/auth-v0.0.1...auth-v0.1.0) (2026-04-05)


### Features

* **deploy:** Kustomize·HPA·Alpine Docker 이미지 구성 추가 ([7df30a3](https://github.com/kangjuhyup/auth/commit/7df30a32c9750cb02fb303f50525b5a80ddee551))
...
* **k8s/istio:** Istio overlay 추가 ([4357d66](https://github.com/kangjuhyup/auth/commit/4357d664d96294cd653f258874fe735e7ef30db6))
* **k8s/overlay:** ingress overlay 업데이트 및 Traefik overlay 추가 ([13fb3cb](https://github.com/kangjuhyup/auth/commit/13fb3cb07eaf0703dfc6a8f26589d7a1a43ebd71))
* **k8s:** auth-service StatefulSet 전환 및 UI 리소스 추가 ([2e4dd53](https://github.com/kangjuhyup/auth/commit/2e4dd539926ab8c3b755268e32e149e117248a9c))
...
* **service:** Interaction SPA 생성 (Vite + React) ([de0dc19](https://github.com/kangjuhyup/auth/commit/de0dc1991bb592936f50a9b91ec7f37e3580aecd))
...
* **ui:** connect admin login to backend session api ([e5e8a94](https://github.com/kangjuhyup/auth/commit/e5e8a9430a2c9a1a3116512ca77ebe823491e54e))
* **ui:** 관리 API 연동을 테넌트·경로 변경에 맞춤 ([7302ebc](https://github.com/kangjuhyup/auth/commit/7302ebcd6e7e8f26824be306566b442a783a118a))
* **ui:** 루트 경로 로그인 리디렉션 및 master 테넌트 자동 선택 ([f7fc4f5](https://github.com/kangjuhyup/auth/commit/f7fc4f54a32ff580451a8b7fa0d32ee20ff84714))
* **ui:** 서버 로그아웃, 세션 영속화 및 데드코드 정리 ([35e222b](https://github.com/kangjuhyup/auth/commit/35e222bc6f583efbf7c5ba83bcae96be879a9ecf))


### Bug Fixes

* **ci:** use .release-please-manifest.json and googleapis release-please-action ([dc49c41](https://github.com/kangjuhyup/auth/commit/dc49c41244e3eafb949883d60bc1de56658a31a3))
