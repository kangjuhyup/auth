...
export class AdminQueryHandler implements AdminQueryPort {
    ...
    return PaginatedResult.of({
      items: items.map((c) =>
        ClientResponse.of({
          ...
          externalInteractionUiUrl: c.externalInteractionUiUrl ?? null,
          allowedResources: c.allowedResources,
          introspectionResources: c.introspectionResources,
  ...
  async getClient(tenantId: string, id: string): Promise<ClientResponse> {
    ...
    return ClientResponse.of({
      ...
      externalInteractionUiUrl: client.externalInteractionUiUrl ?? null,
